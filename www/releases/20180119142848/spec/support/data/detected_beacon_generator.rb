class DetectedBeaconGenerator
  ...
  def initialize
    ...
    @registered_uuid = FactoryGirl.create(:ibeacon_uuid)

    corners = FactoryGirl.create_list(:corner, 4, intersection: @intersection)
    corners.each do |corner|
      FactoryGirl.create(:beacon, corner: corner, ibeacon_uuid: @registered_uuid)
    end
